...
def sbc_cb(data):
    if rospy.get_param('/insect/in_wait', True):
        ...
        rospy.set_param('/insect/RPY_angle_new', rpy_angle)
        rospy.set_param('/insect/in_wait', False)
    return
...
if __name__ == '__main__':
    try:
        ...
        while not rospy.is_shutdown():
            rospy.Subscriber("/insect/imu", Imu, sbc_cb)
            pause.sleep()
