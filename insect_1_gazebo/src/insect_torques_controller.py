...
def insect_joint_torques_publisher():


	#Initiate node for controlling joint1 and joint2 positions.
	rospy.init_node('insect_joint_torque_node', anonymous=True)

	#Define publishers for each joint position controller commands.
	pub1 = rospy.Publisher('/insect/l_f_hip_joint_torque_controller/command', Float64, queue_size=100)
	pub2 = rospy.Publisher('/insect/r_f_hip_joint_torque_controller/command', Float64, queue_size=100)
	pub3 = rospy.Publisher('/insect/l_b_hip_joint_torque_controller/command', Float64, queue_size=100)
	#pub4 = rospy.Publisher('/insect/r_b_hip_joint_torque_controller/command', Float64, queue_size=100)
	#ub5 = rospy.Publisher('/insect/l_f_limb_joint_torque_controller/command', Float64, queue_size=100)
	#pub6 = rospy.Publisher('/insect/r_f_limb_joint_torque_controller/command', Float64, queue_size=100)
	#pub7 = rospy.Publisher('/insect/l_b_limb_joint_torque_controller/command', Float64, queue_size=100)
	#pub8 = rospy.Publisher('/insect/r_b_limb_joint_torque_controller	/command', Float64, queue_size=100)
...
if __name__ == '__main__':
	try: insect_joint_torques_publisher()
